...
API int ui_subtexture(const char *label, texture_t t, unsigned u0, unsigned v0, unsigned u1, unsigned v1);
...
int ui_subtexture(const char *label, texture_t t, unsigned u0, unsigned v0, unsigned u1, unsigned v1) {
