...
:dir_ext
curl -s "https://api.github.com/search/repositories?q=ext+topic:ext-v1+&sort=created&order=asc" > plugs.0
...
:add
if not exist "%2\@%1" (
    git clone https://github.com/%1/%2 -q && (echo. > "%2\@%1") && echo [x] %1/%2 added
